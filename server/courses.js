...
const COURSES = [
  {
    ...
    description:
      "Un recorrido práctico por amenazas actuales, hardening, monitoreo y respuesta a incidentes.",
    category: "Seguridad",
    level: "Intermedio",
    price: 89000,
    currency: "ARS",
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "les-cs-1", title: "Mapa de riesgos actuales", durationMinutes: 22, sourceUrl: SAMPLE_A, order: 1 },
          { id: "les-cs-2", title: "Superficie de ataque", durationMinutes: 28, sourceUrl: SAMPLE_B, order: 2 },
        ],
      },
      {
        id: "mod-cs-2",
        ...
        lessons: [
          { id: "les-cs-3", title: "Cifrado y sesiones seguras", durationMinutes: 34, sourceUrl: SAMPLE_C, order: 3 },
          { id: "les-cs-4", title: "Simulacro de incidente", durationMinutes: 40, sourceUrl: SAMPLE_D, order: 4 },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "les-dt-1", title: "Entorno y primer notebook", durationMinutes: 18, sourceUrl: SAMPLE_B, order: 1 },
          { id: "les-dt-2", title: "Limpieza de datos", durationMinutes: 26, sourceUrl: SAMPLE_A, order: 2 },
        ],
      },
      {
        id: "mod-dt-2",
        ...
        lessons: [
          { id: "les-dt-3", title: "Visualización efectiva", durationMinutes: 24, sourceUrl: SAMPLE_D, order: 3 },
          { id: "les-dt-4", title: "Proyecto final guiado", durationMinutes: 36, sourceUrl: SAMPLE_C, order: 4 },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "les-ld-1", title: "Roles y claridad", durationMinutes: 20, sourceUrl: SAMPLE_C, order: 1 },
          { id: "les-ld-2", title: "Conversaciones difíciles", durationMinutes: 27, sourceUrl: SAMPLE_A, order: 2 },
        ],
      },
      {
        id: "mod-ld-2",
        ...
        lessons: [
          { id: "les-ld-3", title: "Métricas que importan", durationMinutes: 23, sourceUrl: SAMPLE_B, order: 3 },
          { id: "les-ld-4", title: "Caso integral de equipo", durationMinutes: 32, sourceUrl: SAMPLE_D, order: 4 },
        ],
      },
    ],
  },
...
module.exports = { COURSES, toPublicCourse, findLesson };
